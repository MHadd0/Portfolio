      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 gap-5'> 
        {workData.map((project, index) => (
          ...
          >
            ...
            <div className='absolute inset-0 bg-black bg-opacity-80 flex flex-col justify-start p-5 text-white opacity-0 group-hover:opacity-85 transition-opacity duration-300 z-30'>
